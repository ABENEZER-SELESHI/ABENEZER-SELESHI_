...
## 🚀 **What I Do**
> **Building AI-powered, scalable web apps that users love.**

- **Frontend Lead & UI/UX Designer** @ **ShopAlly (A2SV)**  
  → AI e-commerce assistant for AliExpress  
  → **40% faster search** | **30% ↑ engagement** | **300+ beta users** | **1st place** among A2SV teams  

- **Android Developer Intern** @ **INSA**  
  → Real-time voting poll app (Java + Dropwizard)  
  → **30% faster APIs** | **100+ test votes** | **50+ pilot users**
...
Backend    → Node.js • Spring Boot • Dropwizard • FastAPI
